...
public enum ErrorCode {
	...
	GITHUB_APP_INSTALLATION_ALREADY_EXISTS(HttpStatus.CONFLICT, "GITHUB_APP_INSTALLATION_ALREADY_EXISTS",
		"이미 GitHub Organization이 연결되어 있습니다."),
	INVALID_GITHUB_APP_INSTALLATION_STATE(HttpStatus.BAD_REQUEST, "INVALID_GITHUB_APP_INSTALLATION_STATE",
		"GitHub App 설치 요청 상태가 만료되었거나 올바르지 않습니다."),
	INVALID_GITHUB_APP_SETUP_ACTION(HttpStatus.BAD_REQUEST, "INVALID_GITHUB_APP_SETUP_ACTION",
		"GitHub App 설치 완료 요청 작업이 올바르지 않습니다."),
	GITHUB_APP_INSTALLATION_NOT_FOUND(HttpStatus.BAD_REQUEST, "GITHUB_APP_INSTALLATION_NOT_FOUND",
		"GitHub App 설치 정보를 찾을 수 없습니다."),
	INVALID_GITHUB_APP_INSTALLATION_ACCOUNT(HttpStatus.BAD_REQUEST, "INVALID_GITHUB_APP_INSTALLATION_ACCOUNT",
		"GitHub App은 Organization에 설치되어야 합니다."),
