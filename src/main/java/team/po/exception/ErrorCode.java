...
public enum ErrorCode {
	...
	PROJECT_GROUP_MEMBER_NOT_FOUND(HttpStatus.NOT_FOUND, "PROJECT_GROUP_MEMBER_NOT_FOUND", "매칭 사용자 중 존재하지 않는 사용자가 있습니다."),
	PROJECT_GROUP_PERMISSION_DENIED(HttpStatus.FORBIDDEN, "PROJECT_GROUP_PERMISSION_DENIED", "본인만 방장으로 팀 스페이스를 생성할 수 있습니다."),
