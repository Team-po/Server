...
public enum ErrorCode {
	...
	GITHUB_ACCOUNT_ALREADY_LINKED(HttpStatus.CONFLICT, "GITHUB_ACCOUNT_ALREADY_LINKED", "이미 GitHub 계정이 연동되어 있습니다."),
	GITHUB_ACCOUNT_LINKED_TO_ANOTHER_USER(HttpStatus.CONFLICT, "GITHUB_ACCOUNT_LINKED_TO_ANOTHER_USER",
		"이미 다른 사용자에게 연동된 GitHub 계정입니다."),
	GITHUB_ACCOUNT_NOT_LINKED(HttpStatus.NOT_FOUND, "GITHUB_ACCOUNT_NOT_LINKED", "연동된 GitHub 계정이 없습니다."),
	GITHUB_LOGIN_ACCOUNT_UNLINK_NOT_ALLOWED(HttpStatus.CONFLICT, "GITHUB_LOGIN_ACCOUNT_UNLINK_NOT_ALLOWED",
		"GitHub 로그인 계정은 GitHub 연동을 해제할 수 없습니다."),
	INVALID_GITHUB_OAUTH_LINK_STATE(HttpStatus.UNAUTHORIZED, "INVALID_GITHUB_OAUTH_LINK_STATE",
		"GitHub 계정 연동 요청이 만료되었거나 올바르지 않습니다."),
	GITHUB_TOKEN_ENCRYPTION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "GITHUB_TOKEN_ENCRYPTION_FAILED",
		"GitHub 토큰 암호화에 실패했습니다."),
	...
	PROJECT_GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "PROJECT_GROUP_NOT_FOUND", "소속된 팀 스페이스를 찾을 수 없습니다."),
