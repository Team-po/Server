...
CREATE TABLE project_group_github_installation
(
    id                             BIGINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE project_group_github_repository
(
    id                                  BIGINT AUTO_INCREMENT PRIMARY KEY,
    project_group_id                    BIGINT       NOT NULL,
    github_installation_id              BIGINT       NOT NULL,
...
CREATE INDEX idx_project_group_github_installation_github_installation_id
    ON project_group_github_installation (github_installation_id);

CREATE INDEX idx_project_group_github_repository_project_group_id
    ON project_group_github_repository (project_group_id);

CREATE INDEX idx_project_group_github_repository_github_installation_id
    ON project_group_github_repository (github_installation_id);
